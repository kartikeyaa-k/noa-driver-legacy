...
class Home extends StatefulWidget {
  ...
  Home(this.DriverId, {this.driverLogin});
  @override
...
class _HomeState extends State<Home> {
  ...
  //     // print("the timmer is called and location status ${Provider.of<OrderController>(context, listen: false).isLocationon}");

  //     Provider.of<OrderController>(context, listen: false).isLocationon
  //         ? Provider.of<OrderController>(context, listen: false).locatePosition(
  //             widget.driverLogin!.storeId!, currentSelectedSubCommunityId)
  //         : const SizedBox();
  //   });
  // }
                        ...
                        NavUtils.push(
                            ...
                            DeliveryAddressPage(
                              ...
                              onSubmitAddress: (String subCommunityName,
                                  String communityName, String subCommunityId) {
                                setState(() {
                                  isOnline = true;
                                  currentSelectedSubCommunityFromDropdownName =
                                      subCommunityName;
                      ...
                      ? Expanded(
                          child: RefreshIndicator(
                            ...
                            child: provider.currentOrderList.isNotEmpty
                                ? ListView.builder(
                                    shrinkWrap: true,
                                    itemCount: provider.currentOrderList.length,
                                                    ...
                                                    subtitle: Column(
                                                      ...
                                                      children: [
                                                        SizedBox(
                                                            width: 150,
                                                            child: Text(
                                                              "${provider.currentOrderList[index]!.customerViewModel!.customerAddressViewModels![0].address ?? ""}"
                                                              ", ${provider.currentOrderList[index]!.customerViewModel!.customerAddressViewModels![0].addressLine2 ?? ""} ${provider.currentOrderList[index]!.customerViewModel!.customerAddressViewModels![0].addressLine2 ?? ""}",
                                                              style: TextStyle(
                                                                color: AppColors
                                                                    .gray8383,
                                                                fontSize: 10,
                                                    ...
                                                    subtitle: Column(
                                                      ...
                                                      children: [
                                                        SizedBox(
                                                            width: 150,
                                                            child: Text(
                                                              "${provider.previousList[index]!.customerViewModel!.customerAddressViewModels![0].address},"
                                                              " ${provider.previousList[index]!.customerViewModel!.customerAddressViewModels![0].addressLine2}, ${provider.previousList[index]!.customerViewModel!.customerAddressViewModels![0].buildingName}",
                                                              style: TextStyle(
                                                                color: AppColors
                                                                    .gray8383,
                                                                fontSize: 10,
